                    ...
                    <div className='p-0 p-sm-1'> 
                     ...
                     <div className='bread-crum mt-1 p-0 ps-1 d-flex justify-content-between'>
                          <div>
                                ...
                                <span className='fas fa-chevron-right'></span>
                                <Link to={'/dashboard/student'} className='p-0 m-0'> 
                                    Student's Dashboard
                                </Link>                                 
                          </div>
                           {
                     ...
                     <div className='student-content-wrapper m-0 p-0 w-100'>
                         {/* show student content only if user is logged in */}
                         { 
                           (isLoggedIn && userType ==='student') ? 
                                  <StudentContent /> : <IsNotLogin />
                          }
                    </div>
