    ...
    return (
        <div>
            <div className='w-100 p-0 m-0 navbar-wrapper'>
                 <Navbar activePage={'contact'} id='contact'/>
            </div>
             <div className='row w-100 p-0 m-0 main-container'>
                <div className='d-none d-sm-block sidebar-wrapper col-sm-4 col-md-3 p-0 m-0'>
                 ...
                 <div className=' main-content-wrapper contact-section col-12 col-sm-8 col-md-9 p-0 m-0' 
                  ...
                  > 
                    <div className='p-0 p-sm-1'> 
                     ...
                     <div className="contact mt-2 mb-2 py-2 shadow-sm">
                         <ContactForm />
                     </div>
