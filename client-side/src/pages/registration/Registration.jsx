...
import TeacherRegistration from './components/TeacherRegisteration';
    ...
    return (
        <div>
            <div className='w-100 p-0 m-0 navbar-wrapper'>
                 <Navbar activePage={'register'} id='registration'/>
            </div>
             <div className='row w-100 p-0 m-0 main-container'>
                <div className='d-none d-sm-block sidebar-wrapper col-sm-4 col-md-3 p-0 m-0'>
                 ...
                 <div className=' main-content-wrapper registration-section col-12 col-sm-8 col-md-9 p-0 m-0' 
                  ...
                  > 
                    <div className='p-0 p-sm-1'> 
                     ...
                     <div className='bread-crum mt-1 p-0 ps-1'>
                         ...
                         <Link to={'/registration'} className='p-0 m-0'> 
                             registration
                         </Link>
                     </div>   
                     ...
                     <div className='nav-container mt-2 py-2 shadow-sm'>
                        ...
                        <div className='tab-content mt-1'>
                            <div className='tab-pane container active ' id='student-registration'>
                                <StudentRegistration  />
                            </div>
                            <div className='tab-pane container fade' id='teacher-registration'>
                                <TeacherRegistration />
                            </div>                        
                        </div>
                   </div>
