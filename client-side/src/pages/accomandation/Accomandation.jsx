    ...
    return (
        <div>
            <div className='w-100 p-0 m-0 navbar-wrapper'>
                 <Navbar activePage={'accomandation'} id='about' />
            </div>
             <div className='row w-100 p-0 m-0 main-container'>
                <div className='d-none d-sm-block sidebar-wrapper col-sm-4 col-md-3 p-0 m-0'>
                      <Sidebar  activePage={'accomandation'}/>
                 </div>
                 <div className=' main-content-wrapper accomandation-section col-12 col-sm-8 col-md-9 p-0 m-0' 
                  ...
                  > 
                    <div className='p-0 p-sm-1'> 
                     ...
                     <div className='bread-crum mt-1 p-0 ps-1'>
                         ...
                         <Link to={'/accomandation'} className='p-0 m-0'> 
                             Accomandation
                         </Link>
                     </div>   

                    <div className='hostels mt-2 pb-2 shadow-sm'>
                        <MaleHostel />
                        <FemaleHostel />
                    </div>

                    <div className='our-app mt-3 pb-2 shadow-sm'>
                         <h5 className='header mb-0 pt-2 text-center'>
                   ...
                   <div className='blog mt-2 pt-0 pb-2 shadow-sm'>
                      <BlogPosts />
                   </div>
